        ...
        <html lang="en" suppressHydrationWarning>
            <body className="antialiased overflow-x-hidden">
                <div className="min-h-screen flex flex-col bg-brand-beige selection:bg-brand-green/30 relative">
                    ...
                    <header className="relative z-50 py-8 px-6 md:px-16 max-w-[1800px] mx-auto flex flex-col gap-6 lg:flex-row lg:items-center lg:justify-between">
                        <div className="flex items-center justify-between gap-4">
                            <Link href="/" className="flex items-center group">
                                <span className="text-2xl font-black text-brand-dark flex items-center tracking-tighter">
                        ...
                        <div className="flex flex-wrap items-center gap-6 lg:gap-8">
                            ...
                            <div className="flex items-center gap-3">
                                <div className="hidden sm:flex items-center gap-2 p-1.5 bg-white/40 backdrop-blur-md border border-brand-dark/5 rounded-2xl shadow-sm">
                                    ...
                                    <Link
                                        href="https://github.com/SlotScribe"
                                        target="_blank"
